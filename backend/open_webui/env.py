...
if _config_env_hydration_stats is not None:
    log.info(
        'Config env hydration discovered=%s hydrated=%s missing=%s skipped=%s',
        _config_env_hydration_stats['discovered'],
        _config_env_hydration_stats['hydrated'],
